  ...
  return (
    <>
      <section className="p-0 rounded-none md:rounded-[20px] h-full flex flex-col min-w-0">
        <div className="flex flex-col mt-5 gap-8 mb-6 md:mb-8 shrink-0">
          <div className="flex justify-between p-1 lg:h-[56px] items-center">
          <h2 className="hidden md:block text-raiz-gray-950 text-xl md:text-[23px] font-bold leading-7">
            Gateway Settings
          </h2>
         {activeTab === "api-keys" && <div className="flex flex-wrap justify-between items-center gap-3  shrink-0">
