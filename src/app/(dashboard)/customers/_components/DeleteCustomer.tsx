...
const DeleteCustomer = ({
  ...
  return (
    <div className="p-6 bg-white rounded-lg shadow-md w-96 text-center">
      <h2 className="text-2xl font-bold text-gray-900 mb-4">Delete Customer</h2>
      ...
      <div className="flex justify-end gap-4 mt-6">
        <Button
          ...
          className="px-4 py-2 bg-gray-300 text-white rounded-md disabled:bg-opacity-70 hover:bg-gray-400 transition-colors"
        >
          Cancel
        </Button>
        <Button
