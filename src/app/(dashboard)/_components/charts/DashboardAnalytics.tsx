      ...
      <section className=" w-1/2 flex flex-col  justify-between gap-5 bg-white rounded-2xl border border-[#F3F1F6]">
        ...
        <div className="gap-3 flex flex-col p-4 ">
          <div className="flex justify-between items-center">
            ...
            <div className="flex rounded-lg border border-[#E4DFEE] bg-[#F8F7FA] overflow-hidden">
              {chartTypeArr.map((each, idx) => (
                <button
                  key={each.type}
                  title={each.tooltip}
                  ...
                  className={`w-9 h-9 flex items-center justify-center transition-all duration-200 hover:scale-110 active:scale-95
                    ${
                      chartType === each.type
                        ? "bg-[#EDE9FE] shadow-inner"
                        : "bg-[#F8F7FA] hover:bg-[#F3F0FA]"
                    }
                    ${idx !== 0 ? "border-l border-[#E4DFEE]" : ""}
                  `}
                >
                  {each.icon}
                </button>
