...
const layout = ({ children }: { children: ReactNode }) => {
  return (
    <section className="w-full flex flex-col lg:flex-row gap-4 lg:gap-6 px-0 md:px-4 lg:pl-0 lg:px-6 min-h-0 relative bg-transparent md:bg-[#F8F7FA]">
      <div className="hidden lg:block w-full lg:w-[23%] desktop:w-[26%] lg:shrink-0">
        <SideLayout />
      </div>
